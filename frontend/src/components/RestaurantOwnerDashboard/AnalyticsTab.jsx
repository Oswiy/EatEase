      ...
      <div className="analytics-premium-locked">
        <div className="premium-locked-content">
          ...
          <div className="features-list">
            <ul>
              <li className="feature-text">Advanced occupancy analytics</li>
              <li className="feature-text">Customer demographics</li>
              <li className="feature-text">Peak hour analysis</li>
            </ul>
          </div>
        </div>
      </div>

...
const ManualOccupancyLogger = ({ restaurant, onLogSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${BASE_URL}/api/restaurant/log-occupancy`, {
        method: "POST",
        headers: {
    ...
    <div className="manual-logger">
      ...
      <div className="capacity-display">
        <div className="capacity-meter">
          <div
            ...
            style={{
              ...
              backgroundColor:
                occupancy > restaurant.max_capacity * 0.9
                  ? "#ff6b6b"
                  : occupancy > restaurant.max_capacity * 0.75
                    ? "#ff922b"
                    : occupancy > restaurant.max_capacity * 0.5
                      ? "#fcc419"
                      : "#51cf66",
            }}
          ></div>
        ...
        <div className="capacity-info">
          <span>
            {occupancy} / {restaurant.max_capacity} (
            {Math.round((occupancy / restaurant.max_capacity) * 100)}%)
          </span>
        </div>
      </div>
      ...
      <div className="logger-info">
        <p>
          <strong>Why log occupancy?</strong>
        </p>
        <ul>
